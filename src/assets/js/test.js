...
function getApiToken() {
  ...
  //data.append("Account", "PVNERP");
  //data.append("Password", "n*8uyti9%i");
  //data.append("client_id", "eip.web");
  ...
  xhr.open("GET", "https://api.herotraveldn.com/api/v1/product/test");
...
function gridRowClick(pGridId) {
     ...
     var tGrid001 = document.getElementById("grid001").value;
      ...
      let grid001ColumnIds = ["","tb_008","tb_007","hn_date_001","hn_date_002","hn_date_004","hn_leave_absence","drp_001","tarea_001","tb_012","tb_011"];
      ...
      if (grid001Obj.getRowIndex() > -1) {
          for (var i = 0; i < grid001ColumnIds.length; i++) {
              if (grid001ColumnIds[i] != "") {
                  ...
                  tReplaceData = changeSpecialValue(tReplaceData.toString(),1);
